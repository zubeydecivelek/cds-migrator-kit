...
from cds_migrator_kit.rdm.migration.transform.xml_processing.quality.parsers import StringValue, clean_str, clean_val
...
def title(self, key, value):
    ...
    remainder_title = StringValue(value.get("b"))
    if remainder_title:
        title = StringValue(str(title) + " : " + str(remainder_title))
    title.required()
